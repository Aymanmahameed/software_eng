...
import modell.GameRecord;
import modell.Home;
import modell.PlayerPanel;
import modell.RandomPip;
import modell.addGame;
...
//		add to the root , mach controler
...
//		/////////////////////////////////
	...
	public void handleGameOver(boolean isIntermediate) {
		...
		String t = now.getDayOfMonth() + ","+ now.getMonthValue() + ","+ now.getYear() + ",";
		try {
			addGame.addGameRecordToFile(new GameRecord(t, topPlayer.getShortName(), bottomPlayer.getShortName(),
										pCurrent.getShortName(),RandomPip.mood)); 
		}
		catch (Exception e) {
