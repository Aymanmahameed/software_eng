...
//			System.out.println("diceeeeee "+ i +" ///"+  dices[i].getDiceResult() + dices[i].toString());
		}
//		///
		if(!instance.equals(DieInstance.SINGLE)) {
//			System.out.println(instance);
			if(!RandomPip.mood.equals("easy")) {
				Dice d = new Dice(color.BLACK);
				Random rand = new Random();
				RandomPip.qDiff = rand.nextInt(3)+1;
//				System.out.println(RandomPip.qDiff);
				getChildren().add(d.draw(RandomPip.qDiff));
			}
		}
...
//			System.out.println("res.add dice roll " + dices[i].draw(dices[i].roll()));
