...
//			int too = Integer.parseInt(to);
			...
			if (RandomPip.firstRandomPipQ.equals(too) ||
					RandomPip.secondRandomPipQ.equals(too)||
					RandomPip.thRandomPipQ.equals(too) ||
					RandomPip.common.equals(too)) {
				
				QuizApp quizApp = new QuizApp();
				result = quizApp.startQuiz(new Stage(),"1");
...
//				QuizApp quizApp = new QuizApp();
//
//				if (too == RandomPip.firstRandomPipQ ||
//						too == RandomPip.secondRandomPipQ ||
//						too == RandomPip.thRandomPipQ||
//						too == RandomPip.common) {
//					result = quizApp.startQuiz(new Stage(),"1");
//					
//				}
//			}
...
//				}
//				else if (too == RandomPip.firstRandomPipQ ||
//						too == RandomPip.secondRandomPipQ ||
//						too == RandomPip.thRandomPipQ||
//						too == RandomPip.common) {
//					QuizApp quizApp = new QuizApp();
