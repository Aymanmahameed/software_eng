...
public class Pip extends CheckersStorer implements ColorParser {
	...
	public Pip(Color color, double rotation, int pipNum) {
		...
		if(pipNum == Integer.valueOf(RandomPip.common)) {
			input1 = getClass().getResourceAsStream("img/board/orange_point.png");
			input2 = getClass().getResourceAsStream("img/board/orange_point_highlighted.png");
			
			
		}
		else if(pipNum == Integer.valueOf(RandomPip.firstRandomPipQ) ||
				pipNum == Integer.valueOf(RandomPip.secondRandomPipQ) ||
				pipNum == Integer.valueOf(RandomPip.thRandomPipQ) ) {
			input1 = getClass().getResourceAsStream("img/board/red_point.png");
			input2 = getClass().getResourceAsStream("img/board/red_point_highlighted.png");
			
			
		}
		else if(pipNum == Integer.valueOf(RandomPip.RandomPipS)) {
			input1 = getClass().getResourceAsStream("img/board/blue_point.png");
			input2 = getClass().getResourceAsStream("img/board/blue_point_highlighted.png");
			
			
		}
		else {
			input1 = getClass().getResourceAsStream("img/board/" + colorString + "_point.png");
			input2 = getClass().getResourceAsStream("img/board/" + colorString + "_point_highlighted.png");
